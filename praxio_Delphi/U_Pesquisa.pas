...
begin
    ...
    begin
      ...
      ParamByName('descricao').Value := edt_Cod.Text + '%';
      Open;
...
begin
  ...
  if (Length(frm_pdv.Edt_Cod_Cli.Text) >0) and (frm_pdv.Edt_Cod_Cli.Text[1] in ['0'..'9']) then
    //ShowMessage('Numérico')
  else
    frm_pdv.Edt_Cod_Cli.Clear;
